...
import com.app.captured.repository.*;
import com.app.captured.exception.*;
import com.app.captured.dto.*;
...
//		System.out.println(c.getProducts().size());
	...
	public SessionDTO updateCustomerPassword(CustomerDTO customerDTO, String token) {
		...
		if(customerDTO.getMobileId().equals(existingCustomer.getEmailId()) == false) {
	...
	public SessionDTO deleteCustomer(CustomerDTO customerDTO, String token) throws CustomerNotFoundException {
		...
		if(existingCustomer.getEmailId().equals(customerDTO.getMobileId()) 
